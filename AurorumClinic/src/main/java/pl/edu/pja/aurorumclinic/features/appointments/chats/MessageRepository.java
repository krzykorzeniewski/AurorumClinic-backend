...
import pl.edu.pja.aurorumclinic.features.appointments.chats.queries.GetMessageResponse;
...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    @Query("""
            select new pl.edu.pja.aurorumclinic.features.appointments.chats.queries.GetMessageResponse(
